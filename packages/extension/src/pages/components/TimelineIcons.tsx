...
export function IconMoveToPeriod({ className }: IconProps) {
  return (
    <svg
      className={className}
      width="20"
...
export function IconExtendToPeriod({ className }: IconProps) {
  return (
    <svg
      className={className}
      width="20"
...
/** Calendar — used for quick “schedule into this span” actions. */
export function IconScheduleFor({ className }: IconProps) {
  return (
    <svg
      className={className}
      width="20"
